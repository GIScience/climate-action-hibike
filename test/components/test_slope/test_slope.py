...
def test_compute_slope_analysis(default_paths, compute_resources, slopes_mock):
    artifacts = compute_slope_analysis(default_paths, None, compute_resources)
...
def test_summarise_slope(default_slopes_gdf):
    ...
    np.testing.assert_array_equal(histogram_chart.data[0].x, [1, 2, 3, 6])
